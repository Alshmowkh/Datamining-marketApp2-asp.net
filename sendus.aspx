<%@ Page Language="VB" AutoEventWireup="false" CodeFile="sendus.aspx.vb" Inherits="_Default" %>
                        ...
                        <tr>
                            ...
                            <td colspan="2" rowspan="2" style="background-image: none; width: 460px; background-color: #ffffff;" valign="top">
                                ...
                                <table style="width: 400px">
                                    <tr>
                                        <td style="font-size: 12pt; width: 100px; font-weight: bold;">
                                            &nbsp; «·≈Ì„Ì·</td>
                                        <td colspan="2" align="right">
                                            <asp:TextBox ID="TextBox1" runat="server" Width="288px"></asp:TextBox></td>
                                    </tr>
                                    <tr>
                                        <td style="font-weight: bold; width: 100px; height: 29px" valign="top">
                                            «·„Õ ÊÏ</td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" colspan="2" valign="middle" style="height: 29px">
                                            <asp:Button ID="Button1" runat="server" Font-Bold="False" Font-Size="Medium" Text="≈—”«·"
                                                Width="56px" /></td>
                                    </tr>
                                </table>
                                            <br />
