<%@ Page Language="VB" AutoEventWireup="false" CodeFile="device.aspx.vb" Inherits="_Default" %>
                                ...
                                <table dir="rtl" style="width: 432px">
                                    <tr>
                                        <td colspan="3" style="color: #000000" align="center">
                                            <br />
                                            «œŒ· „Ê«’›«  «·ﬁÿ⁄… «·„ÿ·Ê»… «·–Ì  —€» ›Ì ≈÷«› Â«<br />
                                            <br />
                                            <table dir="rtl" style="width: 368px">
                                                <tr>
                                                    <td style="width: 80px; height: 20px">
                                                        «·«”„</td>
                                                    <td style="width: 114px; height: 20px" valign="top">
                                                        <asp:TextBox ID="txtdvname" runat="server" Width="110px"></asp:TextBox></td>
                                                    <td style="width: 80px; height: 20px">
                                                        ‰Ê⁄</td>
                                                    <td style="width: 114px; height: 20px">
                                                        <asp:TextBox ID="txtdvtype" runat="server" Width="110px"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 80px; height: 20px">
                                                        «·„ÊœÌ·</td>
                                                    <td style="width: 114px; height: 20px">
                                                        <asp:TextBox ID="txtdvmodel" runat="server" Width="110px"></asp:TextBox></td>
                                                    <td style="width: 80px; height: 20px">
                                                        «·”—⁄…</td>
                                                    <td style="width: 114px; height: 20px">
                                                        <asp:TextBox ID="txtdvspeed" runat="server" Width="110px"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 80px">
                                                        «·ÕÃ„</td>
                                                    <td style="width: 114px">
                                                        <asp:TextBox ID="txtdvsize" runat="server" Width="110px"></asp:TextBox></td>
                                                    <td style="width: 80px">
                                                        «·”⁄…</td>
                                                    <td style="width: 114px">
                                                        <asp:TextBox ID="txtdvopacity" runat="server" Width="110px"></asp:TextBox></td>
                                                </tr>
                                                <tr>
                                                    <td style="width: 80px">
                                                        «·”⁄—</td>
                                                    <td style="width: 114px">
                                                        <asp:TextBox ID="txtdvcost" runat="server" Width="110px"></asp:TextBox></td>
                                                    <td style="width: 80px">
                                                        √Œ—Ï</td>
                                                    <td style="width: 114px">
                                                        <asp:TextBox ID="txtdvother" runat="server" Width="110px"></asp:TextBox></td>
                                                </tr>
                                            </table>
                                            &nbsp; &nbsp;&nbsp;
                                            <p class="MsoNormal" dir="rtl" style="margin: 0cm 0cm 0pt">
                                                <span lang="AR-SA">
                                                    <asp:Label ID="Label1" runat="server" Font-Bold="False" ForeColor="Red" Text="Label"
                                                        Visible="False" Width="240px"></asp:Label></span>&nbsp;</p>
                                            <p class="MsoNormal" dir="rtl" style="margin: 0cm 0cm 0pt">
                                                <span lang="AR-SA">
                                                    <asp:Button ID="Button5" runat="server" Height="24px" Text="≈÷«›…" Width="72px" />
                                                    <asp:Button ID="Button2" runat="server" Height="24px" Text=" ⁄œÌ·" Width="72px" />
                                                    <asp:Button ID="Button3" runat="server" Height="24px" Text="Õ–›" Width="72px" /></span><br />
                                            <br />
                                            <br />
                                            </p>
                                        </td>
