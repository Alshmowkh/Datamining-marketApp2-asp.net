<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cpanel.aspx.vb" Inherits="_Default" %>
            ...
            <tr>
                <td style="width: 661px; height: 77px" align="center" colspan="7" dir="rtl" valign="bottom">
                    ...
                    <asp:Menu ID="Menu3" runat="server" BackColor="#F7F6F3" DynamicHorizontalOffset="2"
                        ...
                        <Items>
                            <asp:MenuItem NavigateUrl="~/Default.aspx" Text="ÇáÑÆíÓíÉ" Value="Home"></asp:MenuItem>
                            <asp:MenuItem NavigateUrl="~/searchdesk.aspx" Text="ßãÈíæÊÑ ãßÊÈí" Value="dec"></asp:MenuItem>
                            <asp:MenuItem NavigateUrl="~/searchlab.aspx" Text="áÇÈ ÊæÈ" Value="lap"></asp:MenuItem>
                            <asp:MenuItem NavigateUrl="~/searchdvc.aspx" Text="ÇáÞØÚ" Value="dvc"></asp:MenuItem>
                            <asp:MenuItem Text="ÑÇÓÜÜáÜÜäÇ" Value="contact"></asp:MenuItem>
                        </Items>
                    </asp:Menu>
                    </td>
            </tr>
                    ...
                    <table style="width: 600px">
                        <tr>
                            <td rowspan="2" style="background-image: url(image/left.gif); width: 140px" valign="top">
                                <br />
                                            <asp:Button ID="Button2" runat="server" Text=" ÅÖÇÝÉ ãÍá" Width="112px" Font-Size ="14" ForeColor="Blue" Visible="False"/>
                                <br />
                                <br />
                                            <asp:Button ID="Button3" runat="server" Text=" ÅÖÇÝÉ ãÔÑÝ" Width="112px" Font-Size ="14" ForeColor="Blue" Visible="False"/><br />
                                <br />
                                            <asp:Button ID="Button4" runat="server" Text=" ÅÖÇÝÉ ÅÚáÇä" Width="112px" Font-Size ="14" ForeColor="Blue" Visible="False"/></td>
                            <td colspan="2" rowspan="2" style="background-image: none; width: 460px; background-color: #ffffff;" valign="top">
                                ...
                                <table style="width: 360px; height: 136px;">
                                    <tr>
                                        <td style="font-size: 12pt; background-image: none; width: 90px; height: 22px">
                                            <asp:Label ID="Label4" runat="server" Font-Bold="False" ForeColor="Black" Text="ÇÓã ÇáãÔÑÝ"
                                                Visible="False" Width="64px"></asp:Label></td>
                                        <td colspan="2">
                                            <asp:TextBox ID="TextBox1" runat="server" Width="176px"></asp:TextBox>
                                            <asp:Label ID="Label2" runat="server" Font-Bold="False" ForeColor="Red" Text="*"
                                                Visible="False" Width="40px"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 12pt; width: 90px">
                                            <asp:Label ID="Label5" runat="server" Font-Bold="False" ForeColor="Black" Text="ßáãÉ ÇáãÑæÑ"
                                                Visible="False" Width="64px"></asp:Label></td>
                                        <td colspan="2">
                                            <asp:TextBox ID="TextBox2" runat="server" Width="176px" TextMode="Password"></asp:TextBox>
                                            <asp:Label ID="Label3" runat="server" Font-Bold="False" ForeColor="Red" Text="*"
                                                Visible="False" Width="40px"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td style="height: 16px; width: 90px;">
                                        </td>
                                        <td align="center" colspan="2" valign="middle" style="height: 16px">
                                            <asp:Button ID="Button1" runat="server" Font-Bold="False" Font-Size="Medium" Text="ÏÎæá"
                                                Width="56px" /></td>
                                    </tr>
                                </table>
                                            <br />
